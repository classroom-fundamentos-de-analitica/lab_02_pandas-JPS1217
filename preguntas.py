...
def pregunta_03():
    ...
    """
    registrosletras = tbl0["_c1"].value_counts().sort_index()

    return registrosletras
...
def pregunta_04():
    ...
    """
    promedioletra = tbl0.groupby("_c1")["_c2"].mean()
...
def pregunta_07():
    ...
    Name: _c2, dtype: int64
    """
    sumaproductocolumnas = tbl0.groupby("_c1")["_c2"].sum()

    return sumaproductocolumnas
